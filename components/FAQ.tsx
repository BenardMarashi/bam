    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-4">
          <h3 className="text-lg font-semibold text-gray-900 group-hover:text-[#C93C3C] transition-colors pr-4">
            {faq.question}
          </h3>
          <motion.div
...
export default function FAQ() {
  ...
  return (
    <section ref={ref} className="relative py-32 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-[#C93C3C]/15 rounded-full blur-[150px]" />
      <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-[#C93C3C]/15 rounded-full blur-[150px]" />
        ...
        >
          ...
          <Link href="#contact">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="btn-primary shadow-2xl shadow-[#C93C3C]/30"
            >
              {t('contactUs')}
            </motion.button>
          </Link>
